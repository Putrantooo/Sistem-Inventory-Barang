	...
	<div class="animated fadeIn">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body card-block">
						<form action="models/detproduksifix/tambah.php" method="post">
							<div class="row">
								<div class="col-md-10">
									...
									<div class="form-group"><label for="select" class=" form-control-label">Payung</label>
										<select name="kd_payung" id="kd_payung" class="form-control">
											...
											<?php
											include 'inc/koneksi.php';
											$sql_nilai = mysqli_query($koneksi, "SELECT * FROM tb_payung") or die(mysqli_error($con));
											while ($data_nilai = mysqli_fetch_array($sql_nilai)) {
												echo '<option value="' . $data_nilai['kd_payung'] . '">' . $data_nilai['Nama'] . '</option>';
											}
											?>
										</select>
									</div>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<strong class="card-title">Data Detail Produksi Payung</strong>
					</div>
					<div class="card-body">
						<table id="dataTable" class="table table-bordered">
							<thead>
								...
								include 'inc/koneksi.php';
								$no = 1;
								$sql = mysqli_query($koneksi, "SELECT tb_produksifix.kode, tb_produksi.kd_produksi, tb_payung.kd_payung, 
									tb_produksifix.jumlah FROM tb_produksifix
									INNER JOIN tb_produksi ON tb_produksifix.kd_produksi = tb_produksi.kd_produksi
									INNER JOIN tb_payung ON tb_produksifix.kd_payung = tb_payung.kd_payung ORDER BY Kode DESC");
...
include 'inc/koneksi.php';
$no = 1;
$sql = mysqli_query($koneksi, "SELECT * FROM tb_produksifix
	INNER JOIN tb_produksi ON tb_produksifix.kd_produksi = tb_produksi.kd_produksi
	INNER JOIN tb_payung ON tb_produksifix.kd_payung = tb_payung.kd_payung");
while ($data = mysqli_fetch_array($sql)) {
	?>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="models/detproduksifix/edit.php" method="post">
						<div class="row">
							<div class="col-md-6">
			...
			<div class="modal fade" id="hapusModal<?= $data['kode']; ?>" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
				<div class="modal-dialog modal-sm" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="models/detproduksifix/hapus.php" method="post">
								<div>
