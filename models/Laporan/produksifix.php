...
$pdf->MultiCell(19.5, 1, 'Laporan Produksi', 0, 'C');
$pdf->SetX(2.8);
...
$pdf->Cell(4.5, 1, 'KODE PAYUNG', 1, 0, 'C');
$pdf->Cell(4.5, 1, 'NAMA BAHAN', 1, 0, 'C');
$pdf->Cell(4.5, 1, 'JUMLAH', 1, 1, 'C');

// Isi Data di tabel
$query = mysqli_query($koneksi, "SELECT tb_produksi.kd_produksi, tb_payung.kd_payung, tb_payung.Nama, tb_produksifix.jumlah, tb_produksi.Tanggal FROM tb_produksifix
...
while ($row = mysqli_fetch_array($query)) {
    ...
    $pdf->Cell(4.5, 1, $row['kd_payung'], 1, 0, 'C');
    $pdf->Cell(4.5, 1, $row['Nama'], 1, 0, 'C');
